...
Usage:
    python deploy_sigma_rules.py --config config.yml --rules-dir ../../detection-rules/sigma
"""
...
def main():
    parser = argparse.ArgumentParser(
        description='Deploy Sigma rules to Splunk as saved searches'
    )
    parser.add_argument(
        '--config',
        type=Path,
        default='splunk_config.yml',
        help='Path to Splunk configuration file'
    )
    parser.add_argument(
        '--rules-dir',
        type=Path,
    ...
    parser.add_argument(
        '--app',
        default='search',
        help='Splunk app to deploy to (default: search)'
    )
    parser.add_argument(
        '--dry-run',
        action='store_true',
        help='Convert rules but do not deploy to Splunk'
    )
